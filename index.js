...
console.log("Product: ", product); // Prints the value of the product

console.log("Quotient: ", quotient); // Prints the value of the quotient
...
console.log("Is a equal to b?", isEqual); // Prints whehter a is equal to b
